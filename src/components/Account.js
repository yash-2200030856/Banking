...
import { Paper, Typography } from '@mui/material'; // Import Material-UI components
      ...
      <Paper elevation={3} style={{ padding: 20, margin: 20 }}>
        <nav className="navbar">
          <ul>
            ...
            <li><Link to="/LinkAccountNumber">Link Account Number</Link></li> {/* Added Link to LinkAccountNumber */}
            <li><Link to="/AccountInfo">Account Info</Link></li> {/* Added Link to AccountInfo */}
            {loggedIn ? (
